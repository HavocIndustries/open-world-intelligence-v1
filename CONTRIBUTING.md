# Contributing to Open World Intelligence

Thanks for being here. Open World Intelligence is an open foundation for live spatial intelligence in the browser, and it gets better when more people run it, break it, and extend it.
...
```bash
git clone https://github.com/your-org/open-world-intelligence.git
cd open-world-intelligence
nvm install 24.14.0
nvm use 24.14.0
npm install
npm run doctor
...
Open World Intelligence is maintained by [Bilawal Sidhu](https://github.com/bilawalsidhu)
